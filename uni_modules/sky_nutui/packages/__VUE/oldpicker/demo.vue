<template>
  <div class="demo">
    ...
    <nut-oldpicker v-model:visible="show2" :list-data="listData2" title="多列选择" @confirm="confirm2"></nut-oldpicker>
...
const { createDemo } = createComponent('oldpicker');
