<template>
  <div class="demo full">
    ...
    <h2 class="h2">{{ translate('byName') }}</h2>
    ...
    <h2 class="h2">{{ translate('customCheck') }}</h2>
    ...
    <h2 class="h2">{{ translate('showBadge') }}</h2>
    <nut-tabbar>
    ...
    <h2 class="h2">{{ translate('customColor') }}</h2>
    ...
    <h2 class="h2">{{ translate('customQuantity') }}</h2>
    <nut-tabbar unactive-color="#7d7e80" active-color="#1989fa">
      <nut-tabbar-item :tab-title="translate('title')" icon="home"></nut-tabbar-item>
      <nut-tabbar-item :tab-title="translate('title')" icon="category"></nut-tabbar-item>
      <nut-tabbar-item :tab-title="translate('title')" icon="find"></nut-tabbar-item>
    </nut-tabbar>
    <h2 class="h2">{{ translate('fixedBottom') }}</h2>
