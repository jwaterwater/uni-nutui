...
import { Toast } from '@/uni_modules/sky_nutui/packages/nutui.vue';
import Button from '@/uni_modules/sky_nutui/packages/__VUE/button/index.vue';
import Icon from '@/uni_modules/sky_nutui/packages/__VUE/icon/index.vue';
