...
<script lang="ts">
import { useTranslate, currentLang } from '@/uni_modules/nutui/sites/assets/util/useTranslate';
const initTranslate = () =>
  useTranslate({
    'zh-CN': {
      basic: '基本用法',
...
// import icons from '@/uni_modules/nutui/packages/styles/font/iconfont.json';
import icons from '@/uni_modules/nutui/packages/styles/font/config.json';
