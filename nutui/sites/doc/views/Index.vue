...
import Header from '@/nutui/sites/doc/components/Header.vue';
import Nav from '@/nutui/sites/doc/components/Nav.vue';
import DemoPreview from '@/nutui/sites/doc/components/DemoPreview.vue';
import Issue from '@/nutui/sites/doc/components/Issue.vue';
import { RefData } from '@/nutui/sites/assets/util/ref';
import { initSiteLang } from '@/nutui/sites/assets/util/useTranslate';
